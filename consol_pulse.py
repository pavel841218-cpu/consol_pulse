...
NON_CRYPTO_PREFIXES = (
    ...
    "AMD", "SPY", "QQQ", "SOX", "NVDA", "PLTR", "TSLA", "AAPL",
    "MSFT", "AMZN", "META", "GOOG", "INTC", "NFLX", "COIN"
)
...
def check_shelf_before_impulse(candles):
    ...
    for end_idx in [total - 1, total - 2]:
        ...
        for window in range(MIN_SHELF_CANDLES, MAX_SHELF_CANDLES + 1):
            ...
            # 1. Проверка тела полки по MAX_SHELF_WIDTH_PCT
            ...
            # 2. Проверка теней по MAX_SHELF_WICK_WIDTH_PCT
