...
# ============================================================
#                    SHELF SETTINGS (ЖЕСТКИЕ НАСТРОЙКИ)
# ============================================================

MIN_SHELF_CANDLES = 6             # Минимум 6 часов консолидации
MAX_SHELF_CANDLES = 36            # Максимум 36 часов

MAX_SHELF_WIDTH_PCT = 2.5         # Тело полки не шире 2.5%
MAX_SHELF_WICK_WIDTH_PCT = 5.0    # С тенями не шире 5.0%

EMA_FAST = 20
EMA_SLOW = 40
EMA_MAX_SPREAD_PCT = 1.2          # Допустимый спред EMA20/40 (зажим)
...
def check_shelf_before_impulse(candles):
    ...
    for end_idx in [total - 1, total - 2]:
        ...
        for window in range(MIN_SHELF_CANDLES, MAX_SHELF_CANDLES + 1):
            ...
            # 1. Проверка тела полки (Open/Close) — не шире 2.5%
            ...
            # 2. Проверка теней (High/Low) — не шире 5.0%
            ...
            # 4. Проверка сжатия EMA20 и EMA40 по всей длине полки
            ...
            # 5. Фильтр шума: минимум 85% свечей должны иметь полный размах <= 2.0%
