...
MAX_SHELF_WICK_WIDTH_PCT = 5.0    # Полный размах с тенями <= 5.0%
...
def check_shelf_before_impulse(candles):
    ...
    for end_idx in [total - 1, total - 2]:
        ...
        for window in range(MIN_SHELF_CANDLES, MAX_SHELF_CANDLES + 1):
            ...
            # 1. Проверка тела полки по константе MAX_SHELF_WIDTH_PCT (2.5%)
            ...
            # 2. Проверка теней по константе MAX_SHELF_WICK_WIDTH_PCT (5.0%)
            ...
            # 4. Проверка зажима EMA20 и EMA40 по константе EMA_MAX_SPREAD_PCT (1.2%)
            ...
            # 5. Жесткий фильтр шума: 85% свечей с размахом <= 2.0%
